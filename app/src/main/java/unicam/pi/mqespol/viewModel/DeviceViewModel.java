...
public class DeviceViewModel extends AndroidViewModel {
    ...
    /*public void connect(MqttAndroidClient mqttAndroidClient,Context context) throws MqttException {
        WifiManager wm = (WifiManager)context.getSystemService(Context.WIFI_SERVICE);
        WifiInfo connectionInfo = wm.getConnectionInfo();
        int ipAddress = connectionInfo.getIpAddress();
        String ipString = Formatter.formatIpAddress(ipAddress);
        Log.e("TAG","IP WIFI MANAGER "+ ipString);
        mqttAndroidClient = new MqttAndroidClient(context,"tcp:"+ipString+":1883", util.CLIENT_ID);
